...
//here we get the output in on go not like a straming effect 
IChatClient client =
...
#region Streaming 
//here we get the output  a straming effect  like a type writer way 
//string prompt2 = "What is AI ? explain max 20 word";
...
//"Microservices architecture is increasingly popular for building complex applications,as it allows systems to be divided into smaller, independent services that can bedeveloped, deployed, and scaled individually.However, microservices also introduce challenges such as increased system complexity,network latency, and the need for proper service discovery, monitoring, anddistributed logging. Organizations adopting microservices must implement strongDevOps practices, containerization tools like Docker, and orchestration platformssuch as Kubernetes to effectively manage and scale their services."
//""";
...
//Each line is its own review. Output the sentiment of each review in a bulleted list.

//I bought this product and it's amazing. I love it!
//This product is terrible. I hate it.
//I'm not sure about this product. It's okay.
//I found this product based on the other reviews. It worked for a bit, and then stopped working.
//""";
